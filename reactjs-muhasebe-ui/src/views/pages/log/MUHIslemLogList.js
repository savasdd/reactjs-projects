...
class MUHIslemLogList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {}
  }
  ...
  render() {
    ...
    const results = [
      ...
      {'header': 'Kullanıcı Adı', 'field': 'kullaniciAdi', 'width': 160, 'flex': false},
      {'header': 'Metot', 'field': 'metot', 'width': 100, 'flex': false},
      {'header': 'Response', 'field': 'body', 'width': 250, 'flex': true},
      {'header': 'Servis', 'field': 'servis', 'width': 250, 'flex': true},
      {'header': 'Path', 'field': 'path', 'width': 250, 'flex': true},
      {'header': 'Tarih', 'field': 'createDate', 'width': 250, 'flex': true},
      {'header': 'Status', 'field': 'status', 'width': 100, 'flex': false},
    ];
          ...
          <CardHeader className="border-0" style={{backgroundColor: '#EBF5FB', backgroundSize: 'cover'}}>
            <div id="ana_div">
              <div className="div-header" id="div">
                <h3 className="mb-1">İşlem Log Listesi </h3>
              </div>
            </div>
          </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToProps)(MUHIslemLogList);
