...
class MUHKullaniciLogList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {}
  }
  ...
  render() {
    ...
    const results = [
      ...
      {'header': 'Giriş Tarihi', 'field': 'createDate', 'width': 250, 'flex': true},
      {'header': 'Bitiş Tarihi', 'field': 'expireDate', 'width': 250, 'flex': true},
    ];
          ...
          <CardHeader className="border-0" style={{backgroundColor: '#EBF5FB', backgroundSize: 'cover'}}>
            <div id="ana_div">
              <div className="div-header" id="div">
                <h3 className="mb-1">Kullanıcı Log Listesi </h3>
              </div>
            </div>
          </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToProps)(MUHKullaniciLogList);
