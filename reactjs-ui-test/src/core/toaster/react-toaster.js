...
import { TOASTR_REFRESH } from "../actions/Type";

class ReactToaster extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(ReactToaster);